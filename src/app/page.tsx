...
const ThePitch = () => (
  <section id="blueprint" className="scroll-mt-28 pt-6 pb-12 md:pt-10 md:pb-20 px-4 md:px-6 text-center">
    ...
    >
      ...
      <div className="flex flex-row flex-wrap items-center justify-center gap-x-3 gap-y-1 mt-6 text-[10px] sm:text-xs text-[#9a9a9a] font-medium">
        <div className="flex items-center gap-1.5 whitespace-nowrap">
          <CheckCircle2 size={12} className="text-[#16a34a]" /> Takes 2 minutes
        </div>
        <span className="hidden sm:block text-[#e4e1d9]">•</span>
        <div className="flex items-center gap-1.5 whitespace-nowrap">
          <CheckCircle2 size={12} className="text-[#16a34a]" /> No finance degree required
        </div>
      </div>
    </motion.div>
  </section>
...
export default function Home() {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col bg-white text-[#1a1a1a] selection:bg-[#4ade80] selection:text-white">
      ...
      <footer className="bg-[#1a1a1a] text-white rounded-t-[1.5rem] md:rounded-t-[3rem] px-4 md:px-8 py-4 md:py-12 text-center mt-auto">
        <p className="text-[11px] md:text-xs text-[#9a9a9a] max-w-full md:max-w-xl mx-auto mb-2 md:mb-4 leading-tight">
          A bespoke, mathematically rigorous approach to reclaiming your time and opting out of the corporate narrative.
        </p>
        <p className="text-[9px] md:text-[10px] text-[#5c5c5c] max-w-full md:max-w-none mx-auto leading-tight">
